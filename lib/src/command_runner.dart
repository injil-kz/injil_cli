...
const executableName = 'inj';
const packageName = 'injil_cli';
const description = 'My new Dart CLI package';

/// {@template injil_cli_command_runner}
...
/// ```
/// {@endtemplate}
class InjilCliCommandRunner extends CompletionCommandRunner<int> {
  /// {@macro injil_cli_command_runner}
  InjilCliCommandRunner({
    Logger? logger,
